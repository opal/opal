...
platform.process_setegid = (typeof process.setegid === "function") ? process.setegid : ()=>-1;
platform.process_geteuid = (typeof process.geteuid === "function") ? process.geteuid : ()=>-1;
platform.process_seteuid = (typeof process.seteuid === "function") ? process.seteuid : ()=>-1;
platform.process_getgid = (typeof process.getgid === "function") ? process.getgid : ()=>-1;
platform.process_setgid = (typeof process.setgid === "function") ? process.setgid : ()=>-1;
...
platform.process_setuid = (typeof process.setuid === "function") ? process.setuid : ()=>-1;
platform.process_sig_list = (new Map()).set("EXIT",0).set("HUP",1).set("INT",2).set("ILL",4).set("TRAP",5).set("ABRT",6)
                                    ...
                                    .set("POLL",29);
platform.process_kill = (pid, signal)=>process.kill(pid, 'SIG' + signal.toString());
