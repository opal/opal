...
platform.proc_set_title = ()=>not_available("Proc#setproctitle");
...
platform.proc_worker_pid = ()=>not_available("#fork");
platform.proc_exec = ()=>not_available("#exec");
...
platform.dir_home = (_sep)=>glib.get_home_dir();
...
platform.dir_wd = (_sep)=>glib.get_current_dir();
