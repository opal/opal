...
module Opal
  class CLIOptions < OptionParser
    def initialize
      ...
      on('--compile-to-exe TYPE', Opal::AppCreator::APP_TYPES, "Compiles and builds a standalone application with runtime of TYPE. The following TYPEs are supported: #{Opal::AppCreator::APP_TYPES.join(', ')}") do |type|
