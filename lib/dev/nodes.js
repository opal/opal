...
TopScopeNode.prototype.generate = function(opts, level) {
  ...
  pre += 'var nil = $runtime.Qnil, $arg = $runtime.ac, ';
  pre += '$class = $runtime.dc, $def = $runtime.dm, $symbol = $runtime.Y, '
  ...
  if (this.scopeVars.length != 0) {
    pre = 'var ' + this.scopeVars.join(', ') + ';' + pre;
  }
...
YieldNode.prototype.generate = function(opts) {
  ...
  var parts = [block + '.$self'], args = this.args;
