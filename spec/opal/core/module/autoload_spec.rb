...
describe "Module#autoload?" do
  it "returns the name of the file that will be autoloaded" do
    ModuleSpecs::Autoload.autoload :Autoload, "opal/core/module/fixtures/autoload.rb"
    ModuleSpecs::Autoload.autoload?(:Autoload).should == "opal/core/module/fixtures/autoload.rb"
  end
  ...
  it "returns the name of the file that will be autoloaded if an ancestor defined that autoload" do
    ModuleSpecs::Autoload::Parent.autoload :AnotherAutoload, "opal/core/module/fixtures/another_autoload.rb"
    ModuleSpecs::Autoload::Child.autoload?(:AnotherAutoload).should == "opal/core/module/fixtures/another_autoload.rb"
  end

  ruby_version_is "2.7" do
    it "returns nil if an ancestor defined that autoload but recursion is disabled" do
      ModuleSpecs::Autoload::Parent.autoload :InheritedAutoload, "opal/core/module/fixtures/inherited_autoload.rb"
    ...
    it "returns the name of the file that will be loaded if recursion is disabled but the autoload is defined on the classs itself" do
      ModuleSpecs::Autoload::Child.autoload :ChildAutoload, "opal/core/module/fixtures/child_autoload.rb"
      ModuleSpecs::Autoload::Child.autoload?(:ChildAutoload, false).should == "opal/core/module/fixtures/child_autoload.rb"
    end
  end
end
...
describe "Module#autoload" do
  ...
  it "can be overridden with a second autoload on the same constant" do
    ...
    ModuleSpecs::Autoload.autoload :Overridden, "opal/core/module/fixtures/autoload_overridden.rb"
    ModuleSpecs::Autoload.autoload?(:Overridden).should == "opal/core/module/fixtures/autoload_overridden.rb"
  ...
  it "loads the registered constant when it is accessed" do
    ...
    ModuleSpecs::Autoload.autoload :X, "opal/core/module/fixtures/autoload_x.rb"
    @remove << :X
    ModuleSpecs::Autoload::X.should == :x
  end

  it "loads the registered constant into a dynamically created class" do
    cls = Class.new { autoload :C, "opal/core/module/fixtures/autoload_c.rb" }
  ...
  it "loads the registered constant into a dynamically created module" do
    mod = Module.new { autoload :D, "opal/core/module/fixtures/autoload_d.rb" }
  ...
  it "loads the registered constant when it is opened as a class" do
    ModuleSpecs::Autoload.autoload :E, "opal/core/module/fixtures/autoload_e.rb"
  ...
  it "loads the registered constant when it is opened as a module" do
    ModuleSpecs::Autoload.autoload :F, "opal/core/module/fixtures/autoload_f.rb"
  ...
  it "loads the registered constant when it is inherited from" do
    ModuleSpecs::Autoload.autoload :G, "opal/core/module/fixtures/autoload_g.rb"
  ...
  it "loads the registered constant when it is included" do
    ModuleSpecs::Autoload.autoload :H, "opal/core/module/fixtures/autoload_h.rb"
  ...
  it "does not load the file when the constant is already set" do
    ModuleSpecs::Autoload.autoload :I, "opal/core/module/fixtures/autoload_i.rb"
    @remove << :I
  ...
  it "loads a file with .rb extension when passed the name without the extension" do
    ModuleSpecs::Autoload.autoload :J, "opal/core/module/fixtures/autoload_j"
    ModuleSpecs::Autoload::J.should == :autoload_j
  end

  # no TOPLEVEL_BINDIG in Opal
  ...
  it "does not load the file if the file is manually required" do
    ModuleSpecs::Autoload.autoload :KHash, "opal/core/module/fixtures/autoload_k.rb"
    @remove << :KHash

    require "opal/core/module/fixtures/autoload_k.rb"
    ScratchPad.recorded.should == :loaded
    ScratchPad.clear
  ...
  it "ignores the autoload request if the file is already loaded" do
    require  "opal/core/module/fixtures/autoload_s.rb"

    ScratchPad.recorded.should == :loaded
    ScratchPad.clear

    ModuleSpecs::Autoload.autoload :S,  "opal/core/module/fixtures/autoload_s.rb"
    @remove << :S
  ...
  it "retains the autoload even if the request to require fails" do
    filename = "opal/core/module/fixtures/a_path_that_should_not_exist.rb"
  ...
  it "allows multiple autoload constants for a single file" do
    ModuleSpecs::Autoload.autoload :L, "opal/core/module/fixtures/autoload_lm.rb"
    ModuleSpecs::Autoload.autoload :M, "opal/core/module/fixtures/autoload_lm.rb"
  ...
  describe "interacting with defined?" do
    ...
    it "loads an autoloaded parent when referencing a nested constant" do
      module ModuleSpecs::Autoload
        autoload :GoodParent, "opal/core/module/fixtures/autoload_nested.rb"
      end
      @remove << :GoodParent
    ...
    it "returns nil when it fails to load an autoloaded parent when referencing a nested constant" do
      module ModuleSpecs::Autoload
        autoload :BadParent, "opal/core/module/fixtures/autoload_exception.rb"
      end
  ...
  describe "the autoload is triggered when the same file is required directly" do
    before :each do
      module ModuleSpecs::Autoload
        autoload :RequiredDirectly, "opal/core/module/fixtures/autoload_required_directly.rb"
      end
      @remove << :RequiredDirectly
      @path = "opal/core/module/fixtures/autoload_required_directly.rb"
      @check = -> {
        [
    ...
    it "in a nested require" do
      nested = "opal/core/module/fixtures/autoload_required_directly_nested.rb"
      nested_require = -> {
        result = nil
        ScratchPad.record -> {
          result = @check.call
  ...
  describe "during the autoload before the constant is assigned" do
    before :each do
      @path = "opal/core/module/fixtures/autoload_during_autoload.rb"
      ModuleSpecs::Autoload.autoload :DuringAutoload, "opal/core/module/fixtures/autoload_during_autoload.rb"
  ...
  it "does not remove the constant from Module#constants if load raises a RuntimeError and keeps it as an autoload" do
    path = "opal/core/module/fixtures/autoload_raise.rb"
    ScratchPad.record []
    ModuleSpecs::Autoload.autoload :Raise, "opal/core/module/fixtures/autoload_raise.rb"
  ...
  it "does not remove the constant from Module#constants if the loaded file does not define it, but leaves it as 'undefined'" do
    ...
    ScratchPad.record []
    ModuleSpecs::Autoload.autoload :O, "opal/core/module/fixtures/autoload_o.rb"
  ...
  it "returns 'constant' on referring the constant with defined?()" do
    module ModuleSpecs::Autoload::Q
      autoload :R, "opal/core/module/fixtures/autoload.rb"
  ...
  it "loads the file when opening a module that is the autoloaded constant" do
    module ModuleSpecs::Autoload::U
      autoload :V, "opal/core/module/fixtures/autoload_v.rb"
  ...
  it "loads the file that defines subclass XX::CS_CONST_AUTOLOAD < CS_CONST_AUTOLOAD and CS_CONST_AUTOLOAD is a top level constant" do
    module ModuleSpecs::Autoload::XX
      autoload :CS_CONST_AUTOLOAD, "opal/core/module/fixtures/autoload_subclass.rb"
    end
  ...
  describe "after autoloading searches for the constant like the original lookup" do
    it "in lexical scopes if both declared and defined in parent" do
      module ModuleSpecs::Autoload
        ...
        autoload :DeclaredAndDefinedInParent, "opal/core/module/fixtures/autoload_callback.rb"
        class LexicalScope
  ...
  it "does NOT raise a NameError when the autoload file did not define the constant and a module is opened with the same name" do
    module ModuleSpecs::Autoload
      class W
        autoload :Y, "opal/core/module/fixtures/autoload_w.rb"
  ...
  it "does not call #require a second time and does not warn if already loading the same feature with #require" do
    ...
    module ModuleSpecs::Autoload
      autoload :AutoloadDuringRequire, "opal/core/module/fixtures/autoload_during_require.rb"
    end

    -> {
      Kernel.require "opal/core/module/fixtures/autoload_during_require.rb"
  ...
  it "shares the autoload request across dup'ed copies of modules" do
    require "opal/core/module/fixtures/autoload_s.rb"
    @remove << :S
    filename = "opal/core/module/fixtures/autoload_t.rb"
    mod1 = Module.new { autoload :T, "opal/core/module/fixtures/autoload_t.rb" }
    -> {
  ...
  it "raises a TypeError if opening a class with a different superclass than the class defined in the autoload file" do
    ModuleSpecs::Autoload.autoload :Z, "opal/core/module/fixtures/autoload_z.rb"
  ...
  # Opal does not support freezing
  ...
  describe "(concurrently)" do
    it "blocks a second thread while a first is doing the autoload" do
      ModuleSpecs::Autoload.autoload :Concur, "opal/core/module/fixtures/autoload_concur.rb"
      @remove << :Concur
    ...
    it "blocks others threads while doing an autoload" do
      file_path     = "opal/core/module/fixtures/repeated_concurrent_autoload.rb"
    ...
    it "raises a NameError in each thread if the constant is not set" do
      file = "opal/core/module/fixtures/autoload_never_set.rb"
      start = false
    ...
    it "raises a LoadError in each thread if the file does not exist" do
      file = "opal/core/module/fixtures/autoload_does_not_exist.rb"
      start = false
