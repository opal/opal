opal_filter "language" do
  ...
  fails "A lambda expression 'lambda { ... }' assigns variables from parameters for definition '@a = lambda { |*| }'"
  fails "A lambda expression 'lambda { ... }' assigns variables from parameters for definition '@a = lambda { |a, | a }'"
  fails "A lambda expression 'lambda { ... }' assigns variables from parameters for definition '@a = lambda { |a: 1, b: 2| [a, b] }'"
  fails "A lambda expression 'lambda { ... }' assigns variables from parameters for definition '@a = lambda { |a: 1, b:| [a, b] }'"
  fails "A lambda expression 'lambda { ... }' assigns variables from parameters for definition '@a = lambda { |a: 1| a }'"
  fails "A lambda expression 'lambda { ... }' assigns variables from parameters for definition '@a = lambda { |a:, b: 1| [a, b] }'"
  fails "A lambda expression 'lambda { ... }' assigns variables from parameters for definition '@a = lambda { |a:, b:| [a, b] }'"
  fails "A lambda expression 'lambda { ... }' assigns variables from parameters for definition '@a = lambda { |a:| a }'"
  ...
  fails "A lambda literal -> () { } assigns variables from parameters for definition '@a = -> (a: 1, b: 2) { [a, b] }'"
  fails "A lambda literal -> () { } assigns variables from parameters for definition '@a = -> (a: 1, b:) { [a, b] }'"
  fails "A lambda literal -> () { } assigns variables from parameters for definition '@a = -> (a:) { a }'"
  fails "A lambda literal -> () { } assigns variables from parameters for definition '@a = -> (a:, b: 1) { [a, b] }'"
  fails "A lambda literal -> () { } assigns variables from parameters for definition '@a = -> (a:, b:) { [a, b] }'"
  fails "A lambda literal -> () { } assigns variables from parameters for definition '@a = -> (a={}) { a }'"
