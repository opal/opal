...
opal_filter "Exception" do
  ...
  fails "Exception#full_message supports :highlight option and adds escape sequences to highlight some strings" # Expected  "\e[1mTraceback\e[m (most recent call last): \tfrom <internal:corelib/enumerable.rb>:27:16:in `$$3' \tfrom <internal:corelib/runtime.js>:1569:5:in `Opal.yieldX' \tfrom mspec/runner/context.rb:176:34:in `protect' \tfrom <internal:corelib/runtime.js>:1770:5:in `Opal.send' \tfrom <internal:corelib/runtime.js>:1780:5:in `Opal.send2' \tfrom mspec/runner/mspec.rb:114:7:in `instance_exec' \tfrom <internal:corelib/runtime.js>:1770:5:in `Opal.send' \tfrom <internal:corelib/runtime.js>:1780:5:in `Opal.send2' \tfrom <internal:corelib/basic_object.rb>:119:1:in `instance_exec' ruby/core/exception/full_message_spec.rb:17:11:in `new': \e[1mSome runtime error (\e[1;4mRuntimeError\e[1m)\e[m" to include "\e[1mSome runtime error (\e[1;4mRuntimeError\e[m\e[1m)"
