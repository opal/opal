...
opal_filter "File" do
  ...
  fails "File.expand_path expand path with" # Expected "./tmp/bin" == "/home/jan/workspace/opal/spec/tmp/bin" to be truthy but was false
  fails "File.expand_path expands ~ENV['USER'] to the user's home directory" # Expected "/home/jan/workspace/opal/spec/~jan" == "/home/jan" to be truthy but was false
  fails "File.expand_path expands ~ENV['USER']/a to a in the user's home directory" # Expected "/home/jan/workspace/opal/spec/~jan/a" == "/home/jan/a" to be truthy but was false
  fails "File.expand_path raises an ArgumentError if the path is not valid" # Expected ArgumentError but no exception was raised ("/home/jan/workspace/opal/spec/~a_not_existing_user" was returned)
  ...
  fails "File.expand_path returns a String in the same encoding as the argument" # NameError: uninitialized constant Encoding::CP1251
  ...
  fails "File.expand_path with a non-absolute HOME raises an ArgumentError" # Expected ArgumentError (non-absolute home) but no exception was raised ("/home/jan/workspace/opal/spec/non-absolute" was returned)
