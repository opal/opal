opal_filter "Enumerable" do
  ...
  fails "Enumerable#find_all Enumerable with no size when no block is given returned Enumerator size returns nil"
  ...
  fails "Enumerable#select Enumerable with no size when no block is given returned Enumerator size returns nil"
