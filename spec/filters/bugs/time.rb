...
opal_filter "Time" do
  ...
  fails "Time#localtime on a frozen time does not raise an error if already in the right time zone" # NoMethodError: undefined method `localtime' for 2025-02-16 02:43:41 -0000
