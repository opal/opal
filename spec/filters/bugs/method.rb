opal_filter "Method" do
  ...
  fails "A method send with a trailing splatted Object argument calls #to_a"
  fails "A method send with a trailing splatted Object argument wraps the argument in an Array if #to_a returns nil"
  ...
  fails "A method assigns local variables from method parameters for definition 'def m(a:) a end'"
  fails "A method assigns local variables from method parameters for definition 'def m(a, (b, c)) [a, b, c] end'"
  fails "A method assigns local variables from method parameters for definition 'def m((a), (b)) [a, b] end'"
