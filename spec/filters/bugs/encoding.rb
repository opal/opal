...
opal_filter "Encoding" do
  ...
  fails "Marshal.dump when passed an IO calls binmode when it's defined" # Mock 'test' expected to receive write("any_args") at least 1 times but received it 0 times
  ...
  fails "String#force_encoding calls #to_str to convert an object to an encoding name" # Mock 'force_encoding' expected to receive to_str("any_args") exactly 1 times but received it 0 times
  ...
  fails "String#force_encoding raises a TypeError if #to_str does not return a String" # Mock 'force_encoding' expected to receive to_str("any_args") exactly 1 times but received it 0 times
