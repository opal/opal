...
opal_filter "Kernel" do
  ...
  fails "Kernel#exec runs the specified command, replacing current process" # Expected exit status is 0 but actual is 1 for command ruby_exe("bundle exec opal -Rbun C:/Users/Administrator/workspace/opal/tmp/rubyspec_temp/rubyexe.rb") Output:
