...
opal_filter "File" do
  ...
  fails "File.chmod with '0444' makes file readable but not writable or executable" # Expected false == true to be truthy but was false
  fails "File.chmod with '0666' makes file readable and writable but not executable" # Expected false == true to be truthy but was false
  fails "File.directory? calls #to_io to convert a non-IO object" # Exception: Cannot read properties of undefined (reading '0')
  fails "File.directory? returns false if the argument is an IO that's not a directory" # Exception: Cannot read properties of undefined (reading '0')
  ...
  fails "FileTest.directory? calls #to_io to convert a non-IO object" # Exception: Cannot read properties of undefined (reading '0')
  fails "FileTest.directory? returns false if the argument is an IO that's not a directory" # Exception: Cannot read properties of undefined (reading '0')
