...
opal_filter "Exception" do
  fails "Exception#backtrace contains lines of the same format for each prior position in the stack" # Expected "native:in `apply'" =~ /^.+:\d+:in `[^`]+'$/ to be truthy but was nil
