...
- `eval` now keeps the lexical nesting of the calling scope, so a constant is looked up through every enclosing module instead of only the innermost one ([#1724](https://github.com/opal/opal/issues/1724))
